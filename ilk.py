...
with mp_hands.Hands(
  ...
  while cap.isOpened():
    ...
    if not success:
      print("Kamera Qarsisinda elleri qaldirin!")
    ...
    if len(co) == 2:
        ...
        if co[0][0] > co[1][0] and co[0][1]>co[1][1] and co[0][1] - co[1][1] > 65:
            ...
            cv2.putText(image, "Sol", (50, 50), font, 0.8, (0, 255, 0), 2, cv2.LINE_AA)
            ...
            cv2.putText(image, "Sag", (50, 50), font, 0.8, (0, 255, 0), 2, cv2.LINE_AA)
